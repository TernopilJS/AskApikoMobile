...
const defaultStyles = {
  container: {
    flex: 1,
    backgroundColor: colors.googleAutocomplete.background,
  },
  textInputContainer: {
    backgroundColor: colors.googleAutocomplete.inputContainerBackground,
    height: 44,
    borderTopColor: colors.googleAutocomplete.inputContainerBorderTop,
    borderBottomColor: colors.googleAutocomplete.inputContainerBorderBottom,
    borderTopWidth: 1 / PixelRatio.get(),
    borderBottomWidth: 1 / PixelRatio.get(),
    flexDirection: 'row',
  },
  textInput: {
    backgroundColor: colors.googleAutocomplete.inputBackground,
    height: 28,
    borderRadius: 5,
    paddingTop: 4.5,
    paddingBottom: 4.5,
  ...
  poweredContainer: {
    ...
    alignItems: 'center',
    backgroundColor: colors.googleAutocomplete.poweredBackground,
  },
  powered: {},
  listView: {
    // flex: 1,
  ...
  separator: {
    ...
    backgroundColor: colors.googleAutocomplete.separator,
  },
  description: {},
  loader: {
    // flex: 1,
...
export default class GooglePlacesAutocomplete extends Component {
   ...
   */
  triggerBlur = () => {
    // console.log(Object.keys(this.textInputRef))
  ...
  _onPress = async (rowData) => {
    if (rowData.isPredefinedPlace !== true && this.props.fetchDetails === true) {
      ...
      try {
        await this.props.askForLocation();
      } catch (err) {
    ...
    return (
      <ScrollView
        ...
        <Touchable
          ...
          underlayColor={this.props.listUnderlayColor || colors.googleAutocomplete.defaultUnderlay}
        >
  ...
  render() {
    ...
    const { CustomTextInput } = this.props;
    return (
      <View
        ...
        {!CustomTextInput ? (
          ...
          <View style={[containerStyle, {elevation: 4}]}>
            <CustomTextInput
              ...
              getRef={(ref) => { this.textInputRef = ref; }}
              returnKeyType={this.props.returnKeyType}
              autoFocus={this.props.autoFocus}
              value={this.state.text}
              placeholder={this.props.placeholder}
              placeholderTextColor={this.props.placeholderTextColor}
              beforeFocus={onFocus ? () => {this._onFocus(); onFocus()} : this._onFocus}
              beforeCancel={onBlur}
              clearButtonMode="while-editing"
              underlineColorAndroid={this.props.underlineColorAndroid}
              { ...userProps }
...
GooglePlacesAutocomplete.defaultProps = {
  placeholder: 'Search',
  placeholderTextColor: colors.googleAutocomplete.defaultPlaceholder,
